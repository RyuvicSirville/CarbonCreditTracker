        ...
        <div>
            ...
            <div class="">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-10 px-20 w-screen mx-auto">
                    <div class="px-{30px} justify-self-center shadow-2xl border-double border-4 border-grey-900">
                    ...
                    <div class='px-{30px} justify-self-center shadow-2xl shadow-2xl border-double border-4 border-grey-900'>
